...
hl.on("hyprland.start", function ()
    ...
    hl.exec_cmd("gsettings set org.gnome.desktop.interface cursor-size 24 && gsettings set org.gnome.desktop.interface font-name 'Inter 11' && gsettings set org.gnome.desktop.interface monospace-font-name 'Geist Mono 11'")
end)
...
-- Bar, launcher (fuzzel) and notifications (mako) match window transparency (0.85 bg) with the same blur
hl.layer_rule({
    name  = "blur-layers",
