...
hl.config({
    general = {
        ...
        extend_border_grab_area = 15,   -- borders are 0px, so give edges an invisible grab zone
...
-- Animations: speed is in deciseconds (1.5 = 150ms). One ease-out curve (fast start,
-- soft landing) keeps everything quick without looking abrupt; no springs (overshoot).
hl.curve("easeOutQuint", { type = "bezier", points = { {0.23, 1}, {0.32, 1} } })

hl.animation({ leaf = "global",     enabled = true,  speed = 1.5, bezier = "easeOutQuint" })
hl.animation({ leaf = "border",     enabled = false })  -- border_size is 0, nothing to animate
hl.animation({ leaf = "windows",    enabled = true,  speed = 1.5, bezier = "easeOutQuint" })
hl.animation({ leaf = "windowsIn",  enabled = true,  speed = 1.5, bezier = "easeOutQuint", style = "popin 90%" })
hl.animation({ leaf = "windowsOut", enabled = true,  speed = 1.0, bezier = "easeOutQuint", style = "popin 90%" })
hl.animation({ leaf = "fade",       enabled = true,  speed = 1.5, bezier = "easeOutQuint" })
hl.animation({ leaf = "fadeOut",    enabled = true,  speed = 1.0, bezier = "easeOutQuint" })
hl.animation({ leaf = "layers",     enabled = true,  speed = 1.2, bezier = "easeOutQuint", style = "fade" })
hl.animation({ leaf = "layersOut",  enabled = true,  speed = 1.0, bezier = "easeOutQuint", style = "fade" })
hl.animation({ leaf = "workspaces", enabled = false })  -- instant switch
