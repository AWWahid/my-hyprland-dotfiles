...
hl.on("hyprland.start", function ()
    ...
    hl.exec_cmd("gsettings set org.xfce.mousepad.preferences.view use-default-monospace-font false && gsettings set org.xfce.mousepad.preferences.view font-name 'Nimbus Sans 11'")
end)
