...
local fileManager = "yazi-window ~/.local/state/yazi/quick-access"
local menu        = "fuzzel"
...
-- macOS cursor (ful1e5/apple_cursor, latest release, xcursor only), unpacked to ~/.local/share/icons/macOS (command in CLAUDE.md);
...
local closeWindowBind = hl.bind(mainMod .. " + C", hl.dsp.exec_cmd("~/.config/hypr/scripts/close-window.sh"))  -- yazi asks first while copying
